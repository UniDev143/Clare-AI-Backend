...
const recommendationSchema = new mongoose.Schema({
  ...
  rank: {
    type: Number,       // 1 = top recommendation
    required: true
  },
  matchScore: {
    type: Number,       // our algorithm's computed score
    required: true
  },
  explanation: {
    type: String,       // AI-generated "why this product" text
    required: true
  }
}, { _id: false });
...
const scanSchema = new mongoose.Schema({
  ...
  questionnaire: {
    ...
    primaryConcern: {
      type: String,
      enum: ['acne', 'dark_spots', 'dark_circles', 'oiliness',
             'dryness', 'redness', 'wrinkles', 'general'],
      required: true
    }
  },
